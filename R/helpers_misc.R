...
# temporary
source('D:/rapid_refresh/R/grib_download_helpers.R')
source('D:/rapid_refresh/R/grib_read_helpers.R')
source('D:/rapid_refresh/R/nc_helpers.R')
source('D:/rapid_refresh/R/spatial_helpers.R')
source('D:/rapid_refresh/R/temporal_helpers.R')
source('D:/rapid_refresh/helpers_workflow.R')
...
my_file_path = function(what,
  ...
  if( is.list(sub_dir) ) {
    ...
    out_list = sub_dir |> lapply(\(s) my_file_path(what = what,
                                                   base_dir = base_dir,
                                                   sub_dir = s,
                                                   var_nm = var_nm,
                                                   make_dir = make_dir))
    ...
    if( is.list(var_nm) ) {
      ...
      out_list = var_nm |> lapply(\(v) my_file_path(what = what,
                                                    base_dir = base_dir,
                                                    sub_dir = sub_dir,
                                                    var_nm = v,
                                                    make_dir = make_dir))
...
my_archive_dates = function(base_dir, var_nm=NULL, sub_dir=NULL) {
  ...
  nc_info_list = sub_dir |> stats::setNames(sub_dir) |> lapply(\(s) {
    ...
    s_index_path = my_file_path('index', base_dir, s, s_nm)
